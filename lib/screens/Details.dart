          ...
          builder: (context, snapshot) {
            ...
            favorites!.forEach((element) {
              if(element.id == widget.data.id){
                toggle = true;
                Provider.of<MyProvider>(context).FavoriteButton = true;
                favorites!.where((element) => element.IsSelected == 1 ? toggle = true : toggle = false);
              }else{
                Provider.of<MyProvider>(context).FavoriteButton = false;
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                            onPressed: () {
                              toggle = !toggle;
                                toggle == false ? IsSelected =0 : IsSelected =1;
                                Provider.of<MyProvider>(context, listen: false)
                                    .ChangeFavoriteIcon( toggle );
                                if (toggle == false) {
                                  // IsSelected =0;
                                  FavProvider.instance.deleteFev(
                                      widget.data.id);
                                } else {
                                  // IsSelected =1;
                            ...
                            icon: Icon(Provider.of<MyProvider>(context).IconColor),
                        ),
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          '${widget.data.price.current.value*num} ${widget.data
                              .price.currency}',
                          style: const TextStyle(
                            fontSize: 30,
                            fontWeight: FontWeight.bold,
